<?php  
 ...
 {  
      echo 'Login Success, Welcome to student space';  
    ...
    <div class="container">
      <div class="row">
        ...
        $message = "";  
         ...
         $stmnt=$conn->prepare("SELECT * FROM `articles` WHERE optous ='1' and opprimary= '1' and opmiddle= '1' and opsecondary= '1'");
         $stmnt->execute();
                  ...
                  <?php
                        ...
                        $database = "admin_aqua";  
                          $message = "";  
                               ...
                               $stmnt=$conn->prepare("SELECT * FROM students WHERE email= '$mail'");
                              $stmnt->execute();
